...
# ARGS:
#
#   start               Start date for the heatmap
#   end                 End date for the heatmap
#   platform_type       Platform to generate a heatmap for, ie SA or SB
#   data_type           Type of data to generate a heatmap for, ie. GRD or SLC
#
...
def generate_command(
    ...
    cmd = (
        ...
        + platform_type
        + """) and
                g.data_granule_type in ('SENTINEL_1A_FRAME',
                        'SENTINEL_1B_FRAME'  ) and
